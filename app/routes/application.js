...
export default Ember.Route.extend(ApplicationRouteMixin, {
	...
	setupController: function(controller, models) {
		...
		if (this.get("session.content.secure.userLocationId")) {
			this.controller.set("defaultLocation", this.get("session.content.secure.userLocationId"));
		}
		...
		if (dataLayer) {
			if (this.get("session.content.secure.userLocationId")) {
				var locationid = this.get("session.content.secure.userLocationId");
